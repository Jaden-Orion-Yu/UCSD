...
cam.Resolution = '960x720'; % sets webcam resolution
cam.Exposure=0; % sets camera exposure to default
cam.Exposure=-10; % sets exposure time (negative value => longer exposure)
cam.Gain=230; % set internal amplification of signal measured for each pixel
...
% Execute the prior code to obtain a video of your disk accelerating. 
