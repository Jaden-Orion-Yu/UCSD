...
s_speaker = serialport('COM26',115200); % Serialport connection
% create serial object for speaker Arduino
s_move = serialport('COM23',115200);
...
oscObj = visadev('USB0::0x1AB1::0x0588::DS1ET201803567::INSTR');

% [EDIT THE FOLLOWING PARAMETERS BASED ON THE LAB PROCEDURE]
verticalscale1 = .500; % channel 1 vertical scale [V]
verticalscale2 = .200; % channel 2 vertical scale [V]
