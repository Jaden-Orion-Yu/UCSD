...
% Ardino code
% Enter the command serialportlist  into the command window to find the com port number of your Arduino
...
save('MAE170_lab3part1','time','voltage'); % save time and voltage to mat file
csvwrite('MAE170_lab3part1',[time, voltage]); % save time and voltage to csv file
saveas(gcf,'MAE170_lab3part1'); % save figure