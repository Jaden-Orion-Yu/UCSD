function [I]=intLE(f, n, a, b)
%
% Objective: Approximate the integral of function f using the left endpoint
% method
%
% input variables:
...
%
% output variables:
%   I - Integral approximation using the Left endpoitn method
%
% Functions called
%   none
%
...
for i = 0:1:(n-1)
    ...
    % value of the function at a those given points.
    k = i*h;
    I = I + f(k);
end
%
