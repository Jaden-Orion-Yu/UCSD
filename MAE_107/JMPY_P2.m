...
% value of β2 being 0.5, and the other being 0.25. The final plot is
% comparing the error with Functional evaluations of each function. the
% FE per step for Euler is 1,for RK2 is 2, and for RK4 is 4.
%
% Functions called
%   rk2
%   rk4
...
%
% Setting up the Functional evaulation arrays for each method, number of
% Functional evaulations is # of FE's per step * number of steps. 
% FE/step_EUler = 1
% FE/step_RK2b2_a = 2
% FE/step_RK2b2_b = 2
% FE/step_RK4 = 4
...
nexttile([1 4])
hold on
plot(log10(FE_EulerCustom), log10(errorEulerCustom),log10(FE_RK2b2_a),log10(errorRK2b2_a),log10(FE_RK2b2_b),log10(errorRK2b2_b),log10(FE_RK4),log10(errorRK4))
legend('euler error','RK2 error, β_2 = 0.5','RK2 error β_2 = 0.25','RK4 error')
title('log10(func evlas) vs log10(errors)')
xlabel('log10(func evals)')
ylabel('log10(errors)')
