...
indexmin = find(abs(y1(1:50)-y2(1:50)) == min(abs(y1(1:50)-y2(1:50))));
indexmax = find(abs(y1(51:end)-y2(51:end)) == min(abs(y1(51:end)-y2(51:end)))) + 50;

topsecY = y1(indexmin:indexmax);
bottomsecY = y2(indexmin:indexmax);
solx= x(indexmin:indexmax);


solutions = [solx, solx; topsecY , bottomsecY];
