...
% pos12_aft = [1770 880 50 200];
% pos13_aft = [1820 920 50 200];
% pos14_aft = [1870 990 80 200];
% pos15_aft = [1920 1100 80 200];
% pos16_aft = [1970 1200 80 200];
% pos17_aft = [2020 1300 80 200];


posMat_af = [ pos1_aft; pos2_aft; pos3_aft ;pos4_aft ; pos5_aft;
    pos6_aft; pos7_aft; pos8_aft ;pos9_aft ; pos10_aft;
    pos11_aft];
    %pos12_aft; pos13_aft;pos14_aft; pos15_aft; pos16_aft ;pos17_aft];
...
% aft_bin15 = processFunc(aft_C16,ref,dist);
% aft_bin16 = processFunc(aft_C17,ref,dist);
% aft_bin17 = processFunc(aft_C18,ref,dist);
% 
...
% aft_bin(posEditMat_af(15,2):posEditMat_af(15,4),posEditMat_af(15,1):posEditMat_af(15,3) ) = aft_bin15;
% aft_bin(posEditMat_af(16,2):posEditMat_af(16,4),posEditMat_af(16,1):posEditMat_af(16,3) ) = aft_bin16;
% aft_bin(posEditMat_af(17,2):posEditMat_af(17,4),posEditMat_af(17,1):posEditMat_af(17,3) ) = aft_bin17;
% 
